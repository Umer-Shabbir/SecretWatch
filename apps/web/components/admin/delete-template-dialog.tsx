...
export function DeleteTemplateDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.4)] p-4">
      ...
      >
        <h2 id="delete-template-title" className="text-base font-semibold leading-6 text-fg-default">
          Delete template?
        </h2>
        <p id="delete-template-description" className="text-sm text-fg-muted">
          <strong className="text-fg-default">{templateName}</strong> will be permanently deleted. This cannot be undone.
        </p>
