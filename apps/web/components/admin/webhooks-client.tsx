                ...
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded p-1.5 text-fg-muted hover:bg-canvas-subtle hover:text-fg-default sm:min-h-0 sm:min-w-0"
                      title="Edit endpoint"
                    ...
                    <button
                      ...
                      className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded p-1.5 text-fg-muted hover:bg-danger-emphasis/10 hover:text-danger-fg sm:min-h-0 sm:min-w-0"
                      title="Delete endpoint"
                      aria-label={`Delete ${webhook.name} endpoint`}
                    >
                      <svg className="h-4 w-4 sm:h-3.5 sm:w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
