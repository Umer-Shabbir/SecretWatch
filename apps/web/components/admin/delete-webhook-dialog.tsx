...
export function DeleteWebhookDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.4)] p-4">
      ...
      >
        <h2 id="delete-webhook-title" className="text-base font-semibold leading-6 text-fg-default">
          Delete Webhook Endpoint?
        </h2>
        <p id="delete-webhook-description" className="text-sm text-fg-muted">
          <strong className="text-fg-default">{name}</strong> will be permanently removed. It will no longer receive any real-time alerts or event notifications.
        </p>
