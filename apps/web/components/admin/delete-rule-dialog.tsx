  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.4)] p-4">
      <div
        ...
        aria-describedby="delete-rule-description"
      ...
      >
        <h2 id="delete-rule-title" className="text-base font-semibold leading-6 text-fg-default">
          Delete rule?
        </h2>
        <p id="delete-rule-description" className="text-sm text-fg-muted">
          <strong className="text-fg-default">{ruleName}</strong> will be permanently deleted. This cannot be undone. Historical findings will retain their matched rule name.
        </p>
